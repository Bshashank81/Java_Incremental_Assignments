...
public class ThirtyDaysWindow {
    public ArrayList<LocalDate> startDateList = new ArrayList<LocalDate>();
    public ArrayList<LocalDate> endDateList = new ArrayList<LocalDate>();
    ...
    public ThirtyDaysWindow(String filename) {
        idObj = new InputDate(filename);
        signUpDate = idObj.getSignUpDate();
        currDate = idObj.getCurrDate();
    }

    public void callingCalculatingDates() throws IOException {
        idObj.input();
        ...
        for (int i = 0; i < signUpDate.size(); i++) {
            ...
            calculatingRangeDates(tempSignUpDate, tempCurrentDate);
        }
    }
